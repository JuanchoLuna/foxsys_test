...
Foxsys UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── foxsys_icons_dark.dart
│   │       │      ├── foxsys_icons_light.dart
│   │       │      └── foxsys_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── foxsys_app_bar.dart
│   │             ├── foxsys_outlined_button.dart
│   │             └── foxsys_text_field.dart 
│   ├── foxsys_ui.dart
│   ├── .gitignore
...
```
2) In `foxsys_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `foxsys_icons_dark.dart` add the icon with its color respectively of the theme. 
