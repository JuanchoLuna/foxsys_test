...
class FOXSYSTextField extends StatelessWidget {

    const FOXSYSTextField({
    super.key,
    this.initialValue,
    this.autoFillHints,
    this.controller,
  ...
  /// extends TextField with email icon and validates input type.
   const FOXSYSTextField.emailTextField({
    super.key,
    this.initialValue,
    this.controller,
    this.inputFormatters,
    ...
    this.obscureText,
        ...
        prefix = const Padding(
          padding: EdgeInsets.only(
            left: FOXSYSSpacing.sm,
            right: FOXSYSSpacing.sm,
          ),
          child: Icon(
            Icons.email,
            color: FOXSYSColors.grey,
          ),
        ),
        autocorrect = false;
   ...
   const FOXSYSTextField.passwordTextField({
    super.key,
    this.initialValue,
    this.controller,
    this.inputFormatters,
